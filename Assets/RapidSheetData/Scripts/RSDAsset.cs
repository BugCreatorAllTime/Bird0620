...
namespace Lib.RapidSheetData
{
    ...
    public class RSDAsset : ScriptableObject
    {
        ...
        // 
        [SerializeField]
        public string _cachedJsonData = null;
        ...
        /// </summary>
        /// <returns>true on success</returns>
        public bool PullDataAndCache(Action<bool> onCompleted = null)
        {
            return PullData(true, false, onCompleted);
        }
        
        public bool PullDataCacheAndDeserialize(Action<bool> onCompleted = null)
        {
            return PullData(true, true, onCompleted);
        }
        ...
        private bool PullData(bool cache = true, bool deserialize = true, Action<bool> onCompleted = null)
        {
            ...
            if (request != null)
            {
                ...
                {
                    Debug.Log("Fetch Data Success: " + success + " " + szData);
                    szData = szData.Replace("!A1:Z1000", "");
                    if (success)
                    {
